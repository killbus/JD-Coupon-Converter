		...
		generate.on("click", function(event) {
			...
			function init() {
				...
				$.each(urls, function(n, url) {
					...
					platform = {'pc':'https://coupon.jd.com/ilink/couponActiveFront/front_index.action?key='+key+'&roleId='+roleid+'&to='+to, 'pc2':'http://coupon.jd.com/ilink/couponSendFront/send_index.action?key='+key+'&roleId='+roleid+'&to='+to, 'pc3':'http://act-jshop.jd.com/couponSend.html?callback=&ruleId='+roleid+'&key='+key+'&pin=&platform=0&_='+(new Date().getTime()), 'm':'http://coupon.m.jd.com/coupons/show.action?key='+key+'&roleId='+roleid+'&to='+to, 'm2':'http://s.m.jd.com/activemcenter/mfreecoupon/getcoupon?key='+key+'&roleId='+roleid+'&to='+to+'&_='+(new Date().getTime())+'&sceneval=2&callback=jsonpCBKA&g_ty=ls', 'm3': 'http://api.m.jd.com/client.action?functionId=newBabelAwardCollection&body={%22activityId%22:%223otnUZEkGA4YVeLpTxAfef3gVJn9%22,%22from%22:%22H5node%22,%22scene%22:%221%22,%22args%22:%22key='+key+',roleId='+roleid+'%22}&client=wh5&clientVersion=1.0.0&callback=jsonp', 'wq':'http://wqs.jd.com/promote/2016/getcoupon/index.html?keyid='+key+'&roleid='+roleid+'&rurl='+to};
